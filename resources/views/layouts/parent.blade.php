...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        @forelse ($allNotifications as $notification)
                            <a href="{{ route('notifications.read', $notification->id) }}"
                                class="dropdown-item text-wrap {{ is_null($notification->read_at) ? 'font-weight-bold' : '' }}">
                                <div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        @else
                            <a class="dropdown-item" href="{{ route('my-profile.edit') }}">Profile</a>
                        @endif
                        <div class="dropdown-divider"></div>
            ...
            <div class="sidebar">
                ...
                @auth
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        ...
                        <div class="info">
                            <a href="{{ route('my-profile.edit') }}" class="d-block">{{ Auth::user()->name }}</a>
                        </div>
                    </div>
                @endauth
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2026-2030 <a href="https://adminlte.io">To_Do_App.io</a>.</strong>
            All rights reserved.
